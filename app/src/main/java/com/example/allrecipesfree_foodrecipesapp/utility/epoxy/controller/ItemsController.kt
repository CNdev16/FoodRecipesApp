...
import com.example.allrecipesfree_foodrecipesapp.utility.epoxy.ItemsRecipesEpoxy
...
class ItemsController : EpoxyController() {
    ...
    var itemsRecipe by Delegates.observable(emptyList<ResultResponse>()) { _, _, _ ->
        requestModelBuild()
    }
