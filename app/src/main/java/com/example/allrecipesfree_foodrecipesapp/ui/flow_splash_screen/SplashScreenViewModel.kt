...
class SplashScreenViewModel(
    ...
    fun addAllRecipesData(resultResponse: ResultResponse) {
        viewModelScope.launch {
            when (val result = withContext(Dispatchers.IO) { addAllDataUseCase.execute(resultResponse) }) {
                is UseCaseResult.Success -> {
