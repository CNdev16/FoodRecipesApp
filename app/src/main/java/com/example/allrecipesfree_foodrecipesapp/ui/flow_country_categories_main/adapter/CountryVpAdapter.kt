...
class CountryVpAdapter(private val countryList: List<ServiceResponse>, private val context: Context) :
    RecyclerView.Adapter<CountryVpViewHolder>() {

    private var listener: OnClickCountry? = null

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CountryVpViewHolder {
        return CountryVpViewHolder(
    ...
    override fun onBindViewHolder(holder: CountryVpViewHolder, position: Int) {
...
class CountryVpViewHolder(val binding: ItemCountryBinding) : RecyclerView.ViewHolder(binding.root)